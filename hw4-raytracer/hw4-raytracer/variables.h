...
EXTERN glm::vec3 eye; // The (regularly updated) glm::vector coordinates of the eye 
EXTERN glm::vec3 up;  // The (regularly updated) glm::vector coordinates of the up 
EXTERN GLFWwindow* window; // GLFW created window
